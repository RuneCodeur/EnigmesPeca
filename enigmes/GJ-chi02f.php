...
if(isset($equipes[$_SESSION['equipe']]['liste'][$nomEpreuve]['response']) && $teams[$_SESSION['equipe']]['liste'][$nomEpreuve]['response'] != ''){
...
<p class="texte_stylé">Quel est le nom de l'élément chimique avec le symbole "H" ?</p>
